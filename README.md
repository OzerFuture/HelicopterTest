...
Симуляція польоту реалізована без використання сторонніх асетів через AddForce / AddTorque. Ураховано підйомну силу, тягу, гравітацію, інерцію, опір повітря (drag), кутовий момент (torque) та затухання підйомної сили на висоті.
